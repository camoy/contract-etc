...
(module+ test
  (chk
   ...
   #:do (define/contract z
          (channel*/c number? integer?)
          (make-channel))
   #:do (thread (λ () (channel-put z 11)))
   (channel-get z)  11

   #:do (define/contract x-async
          (async-channel*/c integer? number?)
          (make-async-channel))
   #:do (async-channel-put x-async 11.5)
   #:x (async-channel-get x-async)
   "the async channel get of"

   #:do (define/contract y-async
          (async-channel*/c number? integer?)
          (make-async-channel))
   #:x (async-channel-put y-async 11.5)
   "the async channel put of"

   #:do (define/contract z-async
          (async-channel*/c number? integer?)
          (make-async-channel))
   #:do (async-channel-put z-async 11)
   (async-channel-get z-async)  11
   ))
